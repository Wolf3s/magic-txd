// RenderWare Raster native texture specific logic.
// Logic here is not essential to the raster virtual interface..
#include "StdInc.h"
...
PluginDependantStructRegister <nativeTextureStreamPlugin, RwInterfaceFactory_t> nativeTextureStreamStore;
